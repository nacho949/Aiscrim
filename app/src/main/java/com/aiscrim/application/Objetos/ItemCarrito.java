...
public class ItemCarrito {
    ...
    public static boolean exiteItem(Videojuego game) {
        for (int i = 0; i<CARRITO.size(); i++) {
            if(CARRITO.get(i).game.getNombre().equals(game.getNombre()) && CARRITO.get(i).game.getPlataforma().equals(game.getPlataforma())  && CARRITO.get(i).game.getTipo().equals(game.getTipo())){
